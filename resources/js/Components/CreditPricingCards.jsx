    ...
    return (
        <section className="bg-gray-900">
            <div className="py-8 px-4">
                ...
                <div className="space-y-8 la:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                    {packages.map((p) => (
                        <div
                            key={p.id}
                            className="flex flex-col align-stretch p-6 mx-auto lg:mx-0 max-w-lg text-center ronded-lg border shadow border-gray-600 bg-gray-800 text-white"
                        >
